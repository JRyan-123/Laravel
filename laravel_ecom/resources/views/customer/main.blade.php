        ...
        <div class="hero-visuals">
          <div class="product-showcase" data-aos="fade-left" data-aos-delay="200">
            <div class="product-card featured">
              <img src="{{ asset('home_assets/assets/img/product/product-2.webp')}}" alt="Featured Product" class="img-fluid">
            ...
            <div class="product-grid">
              <div class="product-mini" data-aos="zoom-in" data-aos-delay="400">
                <img src="{{ asset('home_assets/assets/img/product/product-3.webp')}}" alt="Product" class="img-fluid">
          ...
          <div class="col-lg-6">
            <div class="category-featured" data-aos="fade-right" data-aos-delay="200">
              <div class="category-image">
                <img src="{{ asset('home_assets/assets/img/product/product-f-2.webp')}}" alt="Women's Collection" class="img-fluid">
              </div>
            ...
            <div class="row gy-4">
              ...
              <div class="col-xl-6">
                <div class="category-card cat-men" data-aos="fade-up" data-aos-delay="300">
                  <div class="category-image">
                    <img src="{{ asset('home_assets/assets/img/product/product-m-5.webp')}}" alt="Men's Fashion" class="img-fluid">
                  </div>
                  <div class="category-content">
                    <h4>Men's Wear</h4>
                    <p>242 products</p>
              ...
              <div class="col-xl-6">
                <div class="category-card cat-kids" data-aos="fade-up" data-aos-delay="400">
                  <div class="category-image">
                    <img src="{{ asset('home_assets/assets/img/product/product-8.webp')}}" alt="Kid's Fashion" class="img-fluid">
                  </div>
                  <div class="category-content">
                    <h4>Kid's Fashion</h4>
                    <p>185 products</p>
              ...
              <div class="col-xl-6">
                <div class="category-card cat-cosmetics" data-aos="fade-up" data-aos-delay="500">
                  <div class="category-image">
                    <img src="{{ asset('home_assets/assets/img/product/product-3.webp')}}" alt="Cosmetics" class="img-fluid">
                  </div>
                  <div class="category-content">
              ...
              <div class="col-xl-6">
                <div class="category-card cat-accessories" data-aos="fade-up" data-aos-delay="600">
                  <div class="category-image">
                    <img src="{{ asset('home_assets/assets/img/product/product-12.webp')}}" alt="Accessories" class="img-fluid">
                  </div>
                  <div class="category-content">
                    <h4>Accessories</h4>
                    <p>308 products</p>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="product-item">
              <div class="product-image">
                ...
                <img src="{{ asset('home_assets/assets/img/product/product-1.webp')}} " alt="Product Image" class="img-fluid" loading="lazy">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="product-item">
              <div class="product-image">
                ...
                <img src="{{ asset('home_assets/assets/img/product/product-4.webp')}}" alt="Product Image" class="img-fluid" loading="lazy">
                <div class="product-actions">
                  <button class="action-btn wishlist-btn">
                    <i class="bi bi-heart"></i>
                  </button>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="product-item">
              <div class="product-image">
                <img src="{{ asset('home_assets/assets/img/product/product-7.webp')}}" alt="Product Image" class="img-fluid" loading="lazy">
                <div class="product-actions">
                  <button class="action-btn wishlist-btn">
                    <i class="bi bi-heart"></i>
                  </button>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="product-item">
              <div class="product-image">
                ...
                <img src="{{ asset('home_assets/assets/img/product/product-10.webp')}}" alt="Product Image" class="img-fluid" loading="lazy">
                <div class="product-actions">
            ...
            <div class="product-category">
              ...
              <div class="product-list">
                <div class="product-card">
                  <div class="product-image">
                    <img src="{{ asset('home_assets/assets/img/product/product-1.webp')}}" alt="Premium Leather Tote" class="img-fluid">
                ...
                <div class="product-card">
                  <div class="product-image">
                    <img src="{{ asset('home_assets/assets/img/product/product-3.webp')}}" alt="Statement Earrings" class="img-fluid">
                  </div>
                  <div class="product-info">
                ...
                <div class="product-card">
                  <div class="product-image">
                    <img src="{{ asset('home_assets/assets/img/product/product-5.webp')}}" alt="Organic Cotton Shirt" class="img-fluid">
                  </div>
                  <div class="product-info">
          ...
          <div class="col-lg-4 col-md-6 mb-5 mb-md-0" data-aos="fade-up" data-aos-delay="300">
            <div class="product-category">
              ...
              <div class="product-list">
                <div class="product-card">
                  <div class="product-image">
                    <img src="{{ asset('home_assets/assets/img/product/product-2.webp')}}" alt="Slim Fit Denim" class="img-fluid">
                    <div class="product-badges">
                ...
                <div class="product-card">
                  <div class="product-image">
                    <img src="{{ asset('home_assets/assets/img/product/product-6.webp')}}" alt="Designer Handbag" class="img-fluid">
                  </div>
                  <div class="product-info">
                ...
                <div class="product-card">
                  <div class="product-image">
                    <img src="{{ asset('home_assets/assets/img/product/product-8.webp')}}" alt="Leather Crossbody" class="img-fluid">
                    <div class="product-badges">
          ...
          <div class="col-lg-4 col-md-6 mb-5 mb-md-0" data-aos="fade-up" data-aos-delay="400">
            <div class="product-category">
              ...
              <div class="product-list">
                <div class="product-card">
                  <div class="product-image">
                    <img src="{{ asset('home_assets/assets/img/product/product-7.webp')}}" alt="Pleated Midi Skirt" class="img-fluid">
                  </div>
                  <div class="product-info">
                ...
                <div class="product-card">
                  <div class="product-image">
                    <img src="{{ asset('home_assets/assets/img/product/product-4.webp')}}" alt="Geometric Earrings" class="img-fluid">
                    <div class="product-badges">
                ...
                <div class="product-card">
                  <div class="product-image">
                    <img src="{{ asset('home_assets/assets/img/product/product-9.webp')}}" alt="Structured Satchel" class="img-fluid">
                  </div>
                  <div class="product-info">
